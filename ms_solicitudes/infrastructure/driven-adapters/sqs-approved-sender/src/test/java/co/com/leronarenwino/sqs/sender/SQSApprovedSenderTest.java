...
class SQSApprovedSenderTest {
    private SqsAsyncClient client;
    private SQSApprovedSender sender;

    @BeforeEach
    void setUp() {
        client = mock(SqsAsyncClient.class);
        SQSApprovedSenderProperties properties = new SQSApprovedSenderProperties("us-east-1", "https://sqs-url", null);
        sender = new SQSApprovedSender(client, properties);
    }
