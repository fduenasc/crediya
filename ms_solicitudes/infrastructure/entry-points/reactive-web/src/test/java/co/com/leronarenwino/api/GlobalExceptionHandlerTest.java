...
class GlobalExceptionHandlerTest {
    ...
    void handleDecodingExceptionTest() {
        ...
        assertEquals(400, detail.getStatus());
        assertEquals("Bad Request", detail.getTitle());
        assertEquals("Formato de solicitud inválido", detail.getDetail());
    }
    ...
    void handleResponseStatusExceptionNotFoundTest() {
        ...
        assertEquals("El recurso solicitado no existe", detail.getDetail());
    }
    ...
    void handleResponseStatusExceptionOtherTest() {
        ...
        assertEquals("Ocurrió un error inesperado al procesar la solicitud", detail.getDetail());
    }
    ...
    void handleR2dbcBadGrammarExceptionTest() {
        ...
        assertEquals("Ocurrió un error en el servidor", detail.getDetail());
    }
